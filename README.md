...
- **Bring-your-own provider** — OpenAI, Anthropic, Stripe (for *your* ARR analytics), and Google OAuth are optional and configurable via `.env`
...
├── services/              # Local todo bridge adapter kept for ~/.hyperclaw/todo.json compatibility
