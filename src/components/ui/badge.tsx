...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-solid border-primary/10 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
