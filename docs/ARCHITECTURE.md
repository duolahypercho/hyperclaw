...
The old Electron Whisper service, bundled ONNX model, and voice UI surface were
removed from the open-source tree. If local transcription returns, it should be
implemented as an opt-in downloader/runtime package, not by committing large
