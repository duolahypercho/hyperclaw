...
1. **Core Infrastructure**
   ...
   - Local-first AI chat system with streaming capabilities
   - Tool ecosystem: local projects/workflows, OpenClaw, knowledge, and agent chat
   - Live2D and VRM character model support (Hiyori character ready)
   - Local-first authentication and connector-backed runtime setup
   - Real-time conversation history and context management

2. **AI Capabilities**

   - AI framework with agent support
...
- Extend existing local-first AI system
...
→ Agent chat: Research attendees
→ Agent chat: Suggest talking points from past interactions
...
→ Agent chat: Offer delegation suggestions
```
