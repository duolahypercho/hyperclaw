...
4. **Run from Command Line**
   ...
   - Example: `cd "C:\Program Files\Hypercho Copanion" && "Hypercho Copanion.exe"`
...
2. Navigate to the installer location:
   ```powershell
   cd "C:\Code\Codebase\Hypercho\Copanion\electron\dist-electron"
   ```
3. Run the installer:
   ```powershell
   .\Copanion-Setup-Local-0.1.0.exe
   ```
