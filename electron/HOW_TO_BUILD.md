...
- `**Hyperclaw Setup 0.1.0.exe**` - The installer (share this!)
...
2. Double-click `Hyperclaw Setup 0.1.0.exe`
...
Output: `electron/dist-electron/Hyperclaw-MacOS-0.1.0.dmg`. Upload this file and point the download page to it (e.g. `file/Hyperclaw-MacOS-0.1.0.dmg`). Using **.dmg** instead of .zip avoids macOS showing "damaged" when users open the app.
...
3. Navigate to project directory: `cd C:\Code\Codebase\Hypercho\Hyperclaw\electron`
