...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // Local connector bearer token. Used by hub-direct.ts to authenticate
  // /bridge fallback fetches. Returns "" if the token file is missing
  // (rollout window — connector accepts unauth in non-strict mode).
  getConnectorToken: () => ipcRenderer.invoke("connector:get-token"),
