...
3. Output: `dist-electron/Hyperclaw-Setup-Local-{version}.exe`
...
- **Remote Mode**: App will connect to [https://your-domain.example.com](https://your-domain.example.com)

## Output Location

```
electron/dist-electron/
├── Hyperclaw-Setup-Local-0.1.0.exe  (installer)
