...
export const openclawOnboardingConfig: GuidanceConfig = {
  ...
  steps: [
    ...
    {
      id: "widget-kanban",
      target: "[data-guidance='widget-kanban']",
      title: "Task Board",
      description:
        "Your agents pick up and complete tasks here. Create tasks manually or let agents generate them — track everything on this board.",
      position: "top",
      offset: { x: 0, y: 0 },
      skipIfNotFound: true,
    },
