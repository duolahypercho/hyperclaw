...
// Local office desk area centers around world (-9, 0, -9),
// lounge area around (2, 0, -9). Presets calibrated to local 1800x720 layout.
export const CAMERA_PRESETS = {
  ...
  frontDesk: {
    pos: [-5, 12, 0] as [number, number, number],
    target: [-9, 0, -9] as [number, number, number],
    zoom: 55,
  },
  lounge: {
    pos: [6, 10, -2] as [number, number, number],
    target: [2, 0, -9] as [number, number, number],
    zoom: 55,
  },
