        ...
        <AnimatePresence mode="wait">
          ...
          {step === "name" && (
            ...
            >
              ...
              {error && (
                <p className="text-xs text-destructive bg-destructive/10 rounded-md px-3 py-2 mb-3">
                  {error}
                </p>
              )}
              ...
              <DialogFooter className="pt-4">
                ...
                <Button
                  ...
                  disabled={!deviceName.trim() || creating}
                >
                  {creating ? (
                    <>
          ...
          {step === "setup" && pairing && (
            ...
            >
              <DialogHeader className="pb-4">
                ...
                <DialogDescription className="text-xs">
                  Run this command on the machine where OpenClaw is installed.
                  The pairing token expires in {Math.floor(pairing.expiresIn / 60)} minutes.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-medium text-muted-foreground">
                    1. Download the connector (if you haven't already)
                  </p>
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="text-xs h-8" asChild>
                      <a
                        href="https://github.com/Hypercho-Inc/hyperclaw-connector/releases"
                        target="_blank"
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    This token is single-use and expires in {Math.floor(pairing.expiresIn / 60)} minutes.
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {devices.length > 0
                ...
                : "Manage your connected gateways"}
            </p>
          </div>
          <div className="flex gap-2">
            <Button
