...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Company setup",
    status: "live",
    description: "Your first project workspace: lead, agent crew, issue board, and Linear-style execution.",
    owner: "Project lead",
    agents: [],
    cost: { run: 0, month: 0 },
    runs: 0,
    ...
    nodes: [
      ...
      { id: "issues", kind: "output", x: 520, y: 220, title: "Issue board", body: "kanban + Linear-style assignments", status: "needs", ms: null },
    ],
    edges: [
      ["profile", "channels"],
      ["profile", "crew"],
    ...
    issueCounts: { open: 0, inProgress: 0 },
...
export const TEMPLATES: ProjectTemplate[] = [
  {
    id: "brief",
    name: "Source → Brief",
    desc: "Capture a lead request, assign owners, review, close.",
    chain: ["Lead", "Assign", "Review", "Close"],
    agents: ["orin", "clio", "rell"],
  },
  {
    id: "blank",
    name: "Blank canvas",
    desc: "Start with a lead and a clean issue board.",
    chain: ["Lead", "Backlog"],
    agents: [],
  },
];
