import { HyperchoLowLevelError, HyperchoErrorCode } from "@OS/AI/shared";
...
export function convertServiceAdapterError(
  ...
  const structuredError = new HyperchoLowLevelError({
