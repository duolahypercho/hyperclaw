...
export const CopilotChat = ({
  ...
  useEffect(() => {
    if (!showState) {
      ...
      resetToolStates(); // Clear tool states when closing chat
      setInputValue(""); // Clear input when closing
      // Clean up attachments when chat is closed
        ...
        <CardHeader className="pb-3 border-b border-border/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>{personality.name || "Agent"}</CardTitle>
                  ...
                  {isChatLoading ? (
                    ...
                    <EmptyState
                      ...
                      assistantAvatar={{
                        ...
                        alt: (typeof personality.name === "string" ? personality.name : "") || "Agent",
                      }}
