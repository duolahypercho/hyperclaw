...
import { Bot, User, X, ChevronDown, Plus, Clock, Copy, RefreshCw, ThumbsUp, ThumbsDown } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              {activeProvider === "claude-code" || activeProvider === "codex" ? (
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-1 hover:opacity-80 transition-opacity text-left">
                      <CardTitle className="text-sm">
                        {isHermes ? "Hermes Agent" : (personality.name || "Agent")}
                      </CardTitle>
                ...
                <CardTitle className="text-sm">{isHermes ? "Hermes Agent" : (personality.name || "Agent")}</CardTitle>
              )}
                ...
                <EmptyState
                  ...
                  assistantAvatar={{
                    ...
                    alt: activeProvider === "claude-code" ? "Claude Code"
                      ...
                      : (typeof personality.name === "string" ? personality.name : "") || "Agent",
                  }}
                  personality={{
                    ...personality,
          ...
          <InputContainer
            ...
            placeholder={
              hasChatStarted
                ...
                : `Ask ${personality.name || "Agent"} anything...`
            }
