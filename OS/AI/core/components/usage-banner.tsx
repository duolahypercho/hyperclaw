...
export const getErrorActions = (error: HyperchoError) => {
  switch (error.code) {
    case HyperchoErrorCode.MISSING_API_KEY_ERROR:
      return {
        primary: {
          label: "Show me how",
          onClick: () =>
            window.open(
              "https://docs.copanion.ai/premium#how-do-i-get-access-to-premium-features",
              "_blank",
              "noopener,noreferrer",
            ),
        },
      };
    case HyperchoErrorCode.UPGRADE_REQUIRED_ERROR:
      return {
        primary: {
          label: "Upgrade",
          onClick: () =>
            window.open("https://cloud.copanion.ai", "_blank", "noopener,noreferrer"),
        },
      };
    default:
      return undefined;
...
export function renderCopilotKitUsage(error: HyperchoError, onClose?: () => void) {
