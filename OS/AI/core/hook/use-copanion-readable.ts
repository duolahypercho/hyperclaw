 ...
 */
export interface UseCopanionReadableOptions {
  /**
 ...
 */
export function useCopanionReadable(
  {
    description,
    value,
    parentId,
    ...
    convert,
    available = "enabled",
  }: UseCopanionReadableOptions,
  dependencies?: any[]
): string | undefined {
  const { addContext, removeContext } = useCopanionContext();
